...
const PAYROLL_CARDS = [
  ...
  },
  {
    ...
    badgeColor: "#0f766e",
    title: "Request redo",
    description: "Start a redo from an invoice service line (billing edit).",
    path: "/redo/request",
  },
  {
    key: "redo",
    ...
    badgeBg: "#f0fdfa",
    badgeColor: "#0f766e",
    title: "Redo approvals",
    description: "Approve or reject pending service redo requests before the free visit.",
    path: "/redo/approvals",
  },
  {
    key: "redo-complete",
    ...
    badgeColor: "#047857",
    title: "Complete redo",
    description: "Record products used on an approved redo and create the ₹0 visit invoice.",
    path: "/redo/complete",
  },
  {
    key: "ctc",
